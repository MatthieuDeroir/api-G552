...
const Frame_0x33 = require('../../../Data/Frame/Frame_0x33');
...
describe('Frame_0x33.build', () => {
    ...
    it('31', () => {
        const _message = [
            ...
            0x30, 0x31, 0x31, // Guest Score
            0x31, // Period number
            0x52, // Home Team Fouls
            0x52, // Guest Team Fouls
            0x30, // Home Team Timeout
            0x30, // Guest Team Timeout
            0x30, // Horn
        ...
        const expected = {
            ...
            Period: 1,
            Home_TeamFouls: 8,
            Home_TeamFouls_RS: true,
            Guest_TeamFouls: 8,
            Guest_TeamFouls_RS: true,
            Home_CountTimeout: 0,
            Guest_CountTimeout: 0,
            Horn: false,
            Home_IndividualFoul: [
            ...
            Timer24s_Digit2: 4,
            Horn24s_Status: false,
            Timer24s_Status: false,
            Display_Status: true,
            Display_LED_Mode: 'Fix',
        }
